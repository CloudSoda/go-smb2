...
// Flags
const (
	// SMB2_WATCH_TREE monitors the directory's whole subtree rather than only
	// its immediate children.
	SMB2_WATCH_TREE = 0x0001
)

// CompletionFilter — which changes the server should report.
const (
...
// Action — FILE_NOTIFY_INFORMATION.Action
const (
